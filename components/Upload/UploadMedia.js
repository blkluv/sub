      ...
      <div className="mt-1 mb-2 sm:mt-0 sm:col-span-2">
        ...
        <div
          ...
          className={`max-w-lg flex justify-center px-6 pt-5 pb-6 border-2 rounded-md ${
            dragOverActive
              ? "border-blue border-solid bg-blue"
        ...
        >
          <div className="space-y-1 text-center">
            ...
            {selectedFiles.length > 0 ? (
              <p className="text-xs text-gray-500">{file ? selectedFiles[0].name : selectedFiles[0].webkitRelativePath.split("/")[0]} ({selectedFiles.length} files in folder)</p>
            ) : (
