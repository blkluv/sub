          ...
          <tr key={file.id}>
            <td className="w-screen px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
              <div className="flex flex-row justify-left align-center w-full">
                <div className="w-12">
                  <Image alt="Thumbnail" src={getThumbnail(file)} height={50} width={50} />
                </div>
                ...
                <div className="ml-4">
                  ...
                  <p className="text-md font-light">{makeDatePretty(file.created_at)}</p>
                </div>
              </div>
              <div className="flex flex-row justify-between px-4 w-full mt-2 pt-4">
                ...
                <button onClick={() => openDeleteModal(file)} className="text-red">
