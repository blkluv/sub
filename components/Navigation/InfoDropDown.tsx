      ...
      >
        <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
          <Menu.Item>
            ...
            >
              submarine.me is a product by Pinata. It allows creators to lock their content behind
              various unlocking mechanisms (NFT ownership, retweets, payments, etc) and share
